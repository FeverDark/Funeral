    ...
    public OrderingEdit(String title, DB data, Controller control, int src) {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (textField3.getText().equals(data.getOrdering()[src][0].toString()) && textField2.getText().equals(data.getOrdering()[src][4].toString()) &&
                        textField1.getText().equals(Objects.toString(data.getOrdering()[src][5], "")) &&
                        ((ComboItem) comboBox1.getSelectedItem()).getValue().toString().equals(data.getOrdering()[src][1].toString()) &&
                        ((ComboItem) comboBox2.getSelectedItem()).getValue().toString().equals(data.getOrdering()[src][2].toString()) &&
                        datePicker.toString().equals(data.getOrdering()[src][3].toString())) {
                    Exit();
                } else {
