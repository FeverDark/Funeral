...
public class ContractorEdit extends JFrame {
    ...
    public ContractorEdit(String title, DB data, Controller control, int src) {
        ...
        this.pack();
        textField1.setText(Objects.toString(data.contractor[src][0], ""));
        textField2.setText(Objects.toString(data.contractor[src][1], ""));
        textField3.setText(Objects.toString(data.contractor[src][2], ""));
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (textField1.getText().equals(Objects.toString(data.contractor[src][0], "")) && textField2.getText().equals(Objects.toString(data.contractor[src][1], "")) && textField3.getText().equals(Objects.toString(data.contractor[src][2], ""))) {
                    Exit();
                } else {
                    ...
                    for (int i = 0; i < data.contractor.length; ++i) {
                        if (!textField1.getText().equals(data.contractor[src][0].toString())) {
