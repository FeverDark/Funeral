...
public class EmployerEdit extends JFrame {
    ...
    public EmployerEdit(String title, DB data, Controller control, int src) {
        ...
        checkBox.setSelected((Objects.toString(data.getEmployer()[src][7], "") == "Уволен"));
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (textField1.getText().equals(Objects.toString(data.getEmployer()[src][0], "")) && textField2.getText().equals(Objects.toString(data.getEmployer()[src][1], "")) &&
                        textField3.getText().equals(Objects.toString(data.getEmployer()[src][2], "")) && textField4.getText().equals(Objects.toString(data.getEmployer()[src][3], "")) &&
                        textField5.getText().equals(Objects.toString(data.getEmployer()[src][4], "")) && textField6.getText().equals(Objects.toString(data.getEmployer()[src][5], "")) &&
                        textField7.getText().equals(Objects.toString(data.getEmployer()[src][6], "")) && checkBox.isSelected() == (Objects.toString(data.getEmployer()[src][7], "") == "Уволен")) {
                    Exit();
                } else {
                    ...
                    for (int i = 0; i < data.getEmployer().length; ++i) {
                        if (textField6.getText().equals(Objects.toString(data.getEmployer()[i][5], "")) && !textField6.getText().equals(Objects.toString(data.getEmployer()[src][5], ""))) {
