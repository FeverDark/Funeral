...
public class GraveyardEdit extends JFrame {
    ...
    public GraveyardEdit(String title, DB data, Controller control, int src) {
        ...
        if (data.getGraveyard()[src][5] != null)
            comboBox1.setSelectedIndex(Integer.parseInt(data.getGraveyard()[src][5].toString()));
        addButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (textField1.getText().equals(Objects.toString(data.getGraveyard()[src][0], "")) && textField2.getText().equals(Objects.toString(data.getGraveyard()[src][1], "")) &&
                        textField3.getText().equals(Objects.toString(data.getGraveyard()[src][2], "")) && textField4.getText().equals(Objects.toString(data.getGraveyard()[src][3], "")) &&
                        textField5.getText().equals(Objects.toString(data.getGraveyard()[src][4], "")) &&
                        ((ComboItem) comboBox1.getSelectedItem()).getValue().toString().equals(Objects.toString(data.getGraveyard()[src][5], "NULL"))) {
                    Exit();
                } else {
