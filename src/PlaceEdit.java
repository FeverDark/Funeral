...
public class PlaceEdit extends JFrame {
    ...
    public PlaceEdit(String title, DB data, Controller control, int src) {
        ...
        this.pack();
        textField1.setText(Objects.toString(data.place[src][0], ""));
        textField2.setText(Objects.toString(data.place[src][1], ""));
        textField3.setText(Objects.toString(data.place[src][2], ""));
        addButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (textField1.getText().equals(Objects.toString(data.place[src][0], "")) &&
                        textField2.getText().equals(Objects.toString(data.place[src][1], "")) &&
                        textField3.getText().equals(Objects.toString(data.place[src][2], ""))) {
                    Exit();
                } else {
                    ...
                    for (int i = 0; i < data.place.length; ++i) {
                        if (!textField1.getText().equals(data.place[src][0].toString())) {
